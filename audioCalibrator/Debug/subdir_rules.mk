...
build-231087519:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-231087519-inproc

build-231087519-inproc: ../idle.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-231087519 ../idle.cfg
configPkg/compiler.opt: build-231087519
configPkg/: build-231087519
